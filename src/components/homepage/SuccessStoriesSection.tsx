...
//       after: 'AML Analyst',
//       salary: '£48k',
//       image: 'https://imgtolinkx.com/i/tBsp03VM',
...
//       after: 'Data Analyst',
//       salary: '£52k',
//       image: 'https://imgtolinkx.com/i/sMOMUcWr',
...
//       salary: '£45k',
//       image: 'https://imgtolinkx.com/i/R6JiaBph',
...
import { SuccessStoriesCarousel } from '../success/SuccessStoriesCarousel';
    ...
    <section className="py-16 md:py-24 lg:py-32 bg-muted/30">
      <div className="container max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="font-sans text-xl text-muted-foreground max-w-3xl mx-auto">
            50+ career changers who transformed their professional lives with Titans Careers
          </p>
        </div>
