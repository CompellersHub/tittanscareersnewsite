  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-white to-tc-navy/[0.02] min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-0 -right-1/4 w-[1000px] h-[1000px] bg-gradient-to-tl from-tc-navy/3 to-tc-amber/3 rounded-full blur-[140px] animate-pulse"
        ...
        <div
          className="absolute top-40 right-[15%] w-3 h-3 bg-tc-gold/20 rounded-full animate-float"
          style={{ animationDelay: "0.5s" }}
        />
        <div
          className="absolute bottom-32 left-[20%] w-2 h-2 bg-tc-amber/25 rounded-full animate-float"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute top-[60%] right-[25%] w-2 h-2 bg-tc-gold/30 rounded-full animate-float"
      ...
      <div className="container px-4 py-20 md:py-28 relative z-20">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <h1
              className="font-kanit font-bold leading-[1.1] animate-fade-in"
            ...
            <p
              className="font-sans text-lg leading-relaxed text-tc-dark-grey max-w-xl animate-fade-in"
            ...
            >
              ...
              UK experience needed. Get CPD-accredited training and 12 months of
              career support.
            </p>
            ...
            <div
              className="grid grid-cols-2 gap-4 pt-6 animate-fade-in"
            ...
            >
              <div className="relative group overflow-hidden p-4 bg-white/60 backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_-8px_rgba(0,0,0,0.15)] border border-white/40 hover:shadow-[0_16px_48px_-12px_rgba(251,191,36,0.4)] hover:scale-105 hover:border-tc-amber/50 transition-all duration-500">
                ...
                <div className="relative flex items-center gap-3">
                  ...
                  <span className="font-sans font-semibold text-sm text-tc-navy">
                    CPD Accredited
                  </span>
                </div>
              </div>
          ...
          >
            <div className="relative group">
              ...
              <div className="relative bg-white/70 backdrop-blur-2xl rounded-3xl shadow-[0_30px_90px_-15px_rgba(0,0,0,0.3),0_0_0_1px_rgba(255,255,255,0.5)] p-10 border-2 border-white/60 max-w-sm w-full hover:scale-105 hover:shadow-[0_40px_110px_-20px_rgba(0,0,0,0.4)] transition-all duration-500 overflow-hidden">
                ...
                <div
                  className="absolute inset-0 bg-gradient-to-br from-tc-amber/8 via-transparent to-tc-gold/8 animate-gradient-shift"
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-center gap-1.5">
                      {[...Array(5)].map((_, i) => (
                        ...
                        >
                          <Star className="w-6 h-6 fill-tc-gold text-tc-gold drop-shadow-lg" />
                        </div>
                      ))}
                    </div>
                    <p className="text-tc-navy font-sans font-bold text-lg">
