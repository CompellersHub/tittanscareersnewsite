...
export default function Profile() {
  ...
  const handleSignOut = async () => {
    // Assuming you have a sign-out endpoint or handle this via your auth context
    // If you're still using Supabase auth, you can keep this part
    // Otherwise, call your backend logout endpoint
    try {
      // Example: await authApi.post("/auth/logout");
      // navigate("/");
      await signOut();
      toast.success("Signed out successfully");
      navigate("/");
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-3xl font-bold">
                      {formatDate(orderSummary.last_lms_access)}
                    </div>
                    <p className="text-sm text-muted-foreground mt-1">Learning Activity</p>
                  </CardContent>
                </Card>
                      ...
                      <CardContent className="space-y-6">
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-lg mt-1">
                              {userData.data?.email || "Not available"}
                            </p>
                          </div>
                        </div>
